            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4" style="text-align: center;">Faça o cadastro e comece a aventura</p>
                        ...
                        <div class="social-login" style="text-align: center;">
                            <form action="cadastrar_google.php" method="post">
                        ...
                        <form id="formAuthentication" class="mb-3" action="./functions_cadastro.php" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Nome</label>
                                <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite seu nome de usuário" autofocus />
                            </div>
                            <div class="mb-3">
